%----------------------------------------------------------------------------
% Course Syllabus for Chemistry 351 (c) 2016 by Dale J. Brugh
...
\makeoddhead{courseinformation}%
    {\sffamily Course Syllabus: Chemistry 351 / Spring 2016}{}{\sffamily\thepage}
...
Each \marginnote{-0.1in}{The time required will depend on your level of preparation and ability to focus. Estimates are for a typical student.} of the two weekly course meetings is 110 minutes in length, requiring a total of 3.67 hours per week. For each meeting you can expect to spend about 2 hours outside of class reading, studying, and working exercises. Problem sets will require about five to ten hours during weeks they are assigned. 
%
% --- WEEKLY ROUTINE ---
%
\section{Weekly Routine}
Tuesday and Thursday meetings are primarily dedicated to lecture covering the topics listed on the course website. \marginnote{-0.1in}{Reading assignments should be read before lecture; practice exercises should be worked after lecture.} Reading assignments, practice exercises, and solutions for practice exercises are provided for each topic. A problem set is due most Thursdays. There are three micro exams and three exams; all are given during a normal Thursday class meeting. A detailed course schedule can be found on the course website. 
%
% --- THINGS I GRADE ---
%
...
Problem \marginnote{-0.1in}{Worth 20\% of course score. Lowest one (1) score is dropped.} sets consist of some straightforward and easy-to-solve questions and some that are more challenging and time consuming. They are assigned weekly except during the first week and during weeks with exams; they are due on Thursdays. Problem sets are posted on the course website, and solutions are available in my office. Each problem set is weighted equally. Your lowest single problem set score is dropped before computing your course score. The course website has detailed guidelines for preparing solutions for problems sets.
%
% --- Micro Exams ---
%
\subsection{Micro Exams}
A \marginnote{-0.1in}{Worth 20\% of course score.} micro exam is given about two weeks prior to each exam at the start of a Thursday meeting. Exact dates are in the course schedule. You will be given 50 minutes to complete each micro exam. The topics covered on each micro exam are listed on the course website. Solutions to micro exams are posted on the course website after they are graded. Each micro exam is weighted equally. 
%
% --- Exams ---
%
\subsection{Exams}
Three \marginnote{-0.1in}{Worth 30\% of course score.} exams are given during the semester. Each is given during a normal Thursday class meeting. They require the entire class period to complete. All exams are cumulative. Solutions for exams are available in my office. See the course website for the exam schedule. Each exam is weighted equally. 
%
% --- Final Exam ---
%
\subsection{Final Exam}
The \marginnote{-0.1in}{Worth 30\% of course score.} final exam is given on the day and in a time slot specified by the Registrar. The final exam is cumulative over the entire semester. No solutions to the final exam are posted, but you may review the grading by making an appointment with me. You may not take possession of the exam. 
%
